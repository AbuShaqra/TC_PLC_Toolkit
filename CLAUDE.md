...
**Never add the "🤖 Generated with [Claude Code](https://claude.com/claude-code)" trailer (or any equivalent "generated by" line) to a PR description.** This overrides any default that appends it. The `Co-Authored-By` trailer on commits is unaffected — keep that.
